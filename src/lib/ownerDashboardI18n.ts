...
const EN = {
  ...
  'today.status.checked_in': 'Checked in',
  'today.status.in_progress': 'In progress',
  'today.status.no_show': 'No show',
  'today.status.disputed': 'Disputed',
  ...
  'status.start': 'Start service',
  'status.noShow': 'Mark no-show',
  'status.dispute': 'Mark disputed',
...
const HI: Record<OwnerDashboardTextKey, string> = {
  ...
  'today.status.checked_in': 'चेक-इन',
  'today.status.in_progress': 'सेवा जारी है',
  'today.status.no_show': 'ग्राहक नहीं आया',
  'today.status.disputed': 'विवादित',
  ...
  'status.checkIn': 'चेक-इन करें',
  'status.start': 'सेवा शुरू करें',
  'status.noShow': 'नहीं आया चिह्नित करें',
  'status.dispute': 'विवादित चिह्नित करें',
