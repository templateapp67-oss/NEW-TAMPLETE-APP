...
const EN = {
  ...
  'owner.check_in': 'Check in',
  'owner.in_progress': 'Start service',
  'owner.no_show': 'Mark no-show',
  'owner.disputed': 'Mark disputed',
...
const HI: Record<keyof typeof EN, string> = {
  ...
  'owner.check_in': 'चेक-इन करें',
  'owner.in_progress': 'सेवा शुरू करें',
  'owner.no_show': 'नहीं आया चिह्नित करें',
  'owner.disputed': 'विवादित चिह्नित करें',
  ...
  'status.in_progress': 'सेवा जारी है',
  'status.no_show': 'ग्राहक नहीं आया',
