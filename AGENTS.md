...
- `docs/database-migrations-plan.md` + `supabase/migrations/` — **DRAFT** M01–M17.
  They pass clean replay x2 plus tests A–O in PGlite, but have **not been applied
...
- **Verification**: after UI/feature changes, run
  ...
  run `npm run validate:migrations` and keep the 17/17 x2 + 15/15 result.
