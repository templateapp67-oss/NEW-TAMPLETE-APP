...
npm run test:phase-16.7-supabase # real Supabase owner status/RLS guardrails (11 tests)
...
npm run test:phase-17.1    # salon owner dashboard foundation (60 tests)
npm run probe:live-owner   # run the live owner-dashboard diagnostics against the REAL project (.env creds)
